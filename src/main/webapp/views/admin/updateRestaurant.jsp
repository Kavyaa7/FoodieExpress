...
<head>
<meta charset="UTF-8">
<title>Edit Restaurant | FoodieExpress</title>
...
<div class="form-container">
    ...
    <form action="<%=request.getContextPath()%>/editRestaurant" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="cuisineType" value="<%=restaurant.getCuisineType()%>" required>
        </div>

        <div class="form-group">
            <label>Rating</label>
            <input type="number" name="rating" value="<%=restaurant.getRating()%>" min="0" max="5" step="0.1" required>
        </div>

        <div class="form-group">
            <label>Delivery Time (minutes)</label>
            <input type="number" name="deliveryTime" value="<%=restaurant.getDeliveryTime()%>" min="1" required>
        </div>

        <div class="form-group">
            <label>Image Path</label>
            <input type="text" name="imagePath" value="<%=restaurant.getImagePath()%>" required>
        </div>

        <div class="form-group">
            <label>Owner User ID</label>
            <input type="number" name="userId" value="<%=restaurant.getUserId()%>" min="1" required>
        </div>
        <div class="form-group">
            <label>Status</label>
